...
class Engine(object):
    def __init__(self, opt,eval_dataset_real):
        self.opt = opt
        self.writer = None
    ...
    def train(self, train_loader, **kwargs):
        ...
        if True:#not self.opt.no_log:
            if self.epoch % opt.save_epoch_freq == 0:
                ...
                matrix_real=self.eval(self.eval_dataset_real, dataset_name='val40', savedir=save_dir, suffix='val40')
                ...
                sum_PSNR = float(sum_PSNR_real) / 20.0
