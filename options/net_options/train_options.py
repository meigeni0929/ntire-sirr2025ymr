...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--lr', type=float, default=1e-5, help='initial learning rate for adam')
        ...
        # data augmentation
        self.parser.add_argument('--real20_size', type=int, default=460, help='scale images to compat size')
        self.parser.add_argument('--batchSize', '-b', type=int, default=2, help='input batch size')
        self.parser.add_argument('--loadSize', type=str, default='512,512,512', help='scale images to multiple size')  #224，336，448
        self.parser.add_argument('--fineSize', type=str, default='512,512', help='then crop to this size')
