...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--checkpoints_dir', type=str, default='./checkpoints', help='models are saved here')        #重新跑
        self.parser.add_argument('--resume', '-r', action='store_true',default='True', help='resume from checkpoint')
        self.parser.add_argument('--resume_epoch', '-re', type=int, default=0,                #从断点80开始
